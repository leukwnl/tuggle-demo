...
//  Uses InputController for unified pointer input handling.
//
//  ARCHITECTURE:
//  - Manages a container node that holds all fidgetable pages
//  - Pages are arranged horizontally: |Page1|Page2|...|Page8|
...
public:
     ...
     */
    std::shared_ptr<cugl::scene2::SceneNode> getContainer() const { return _container; }
